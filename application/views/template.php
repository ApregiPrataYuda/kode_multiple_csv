...
<body class="hold-transition sidebar-mini">
  ...
  <div class="wrapper">
    ...
    <nav style="background-color:RGB(40, 178, 170);" class="main-header navbar navbar-expand navbar-light navbar-light">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
          <a href="" style="color: RGB(245, 245, 245);" class="nav-link">Admin : Apregi</a>
        </li>
      </ul>
    ...
    <aside style="background-color:RGB(40, 178, 170);" class="main-sidebar sidebar-light elevation-4">
      ...
      <a href="" class="brand-link">
        <img src="<?= base_url() ?>assets/backend/dist/img/AdminLTELogo.png" alt="Logo" class="brand-image">
        <span style="color: RGB(245, 245, 245); font-style: bold;" class="brand-text font-weight-dark">Apregi.co.id</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          ...
          <div class="info">
            <a style="color: RGB(245, 245, 245);" href="#" class="d-block">| <i class="fa fa-user"> <small class="font-weight-bold">Admin</small></i></a>
          </div>
        </div>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li style="font-style: bold; font-size: bold; color: RGB(245, 245, 245);" class="nav-header">Main </li>
              ...
              <li class="nav-item">
                ...
                <ul class="nav nav-treeview ">
                  <li class="nav-item">
                    <a style="color: RGB(245, 245, 245);" href="<?= site_url('Products') ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p style="color: RGB(245, 245, 245);">Products</p>
                    </a>
                  </li>
                </ul>
                <ul class="nav nav-treeview ">
                  <li class="nav-item">
                    <a style="color: RGB(245, 245, 245);" href="<?= site_url('Select_dinamis') ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p style="color: RGB(245, 245, 245);">Select Dinamis</p>
                    </a>
                  </li>
                </ul>
                ...
                <ul class="nav nav-treeview ">
                  <li class="nav-item">
                    <a style="color: RGB(245, 245, 245);" href="<?= site_url('Select_dinamisdua') ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p style="color: RGB(245, 245, 245);">Select Dinamis 3 tbl</p>
                    </a>
                  </li>
                </ul>
                ...
                <ul class="nav nav-treeview ">
                  <li class="nav-item">
                    <a style="color: RGB(245, 245, 245);" href="<?= site_url('csv_read') ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p style="color: RGB(245, 245, 245);">Csv Read</p>
                    </a>
                  </li>
                </ul>
                ...
                <ul class="nav nav-treeview ">
                  <li class="nav-item">
                    <a style="color: RGB(245, 245, 245);" href="<?= site_url('ex_csv') ?>" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p style="color: RGB(245, 245, 245);">Export mysql to Csv</p>
                    </a>
                  </li>
                </ul>
               </li>
            ...
            <!-- <li style="font-style: bold; font-size: bold; color: RGB(245, 245, 245);" class="nav-header">Menu 3 </li> -->
            <li class="nav-item">
  ...
  <script src="<?= base_url() ?>assets/backend/plugins/jquery/jquery.min.js"></script>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2023 <a class="text-info" href="https://Nobby.co.id/">Apregi.co.id</a>.</strong> All rights reserved.
    </footer>
